        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="md:col-span-2 lg:col-span-4 bg-gradient-to-br from-purple-600 to-indigo-700 text-white">
                    <h2 className="text-3xl font-bold">Welcome back, {studentData.profile.name}!</h2>
                    <p className="mt-1 opacity-90">{studentData.profile.program}</p>
                </Card>
                ...
                <Card>
                    ...
                    <p className="text-3xl font-bold text-red-500 mt-2">₹{feesDue.toLocaleString('en-IN')}</p>
                    <p className="text-sm text-gray-500">Due by {new Date(feesDueDate).toLocaleDateString('en-IN', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
                </Card>
